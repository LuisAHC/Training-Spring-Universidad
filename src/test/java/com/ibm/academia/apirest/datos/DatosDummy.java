...
public class DatosDummy {
	...
	{
		return new Carrera(new Long(0), "Ingenieria en Sistemas", 50, 5, "nsegura");
	}

	public static Carrera carrera02() 
	{
		return new Carrera(new Long(1), "Licenciatura en Sistemas", 45, 4, "nsegura");
	}

	public static Carrera carrera03() 
	{
		return new Carrera(new Long(2), "Ingenieria Industrial", 60, 5, "nsegura");
	}
